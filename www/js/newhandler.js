...
$.get('include/newhandlers.php?id=1&name=status&value=all', function(result) {
...
$.get('include/newhandlers.php?id=2&name=status&value=all', function(result) {
...
$.get('include/newhandlers.php?id=4&name=status&value=all', function(result) {
...
$('#1-out2-button-change').click(function() {
    $.get('include/newhandlers.php?id=1&name=out2&value=change', function(result) {
...
$('#1-out3-button-change').click(function() {
    $.get('include/newhandlers.php?id=1&name=out3&value=change', function(result) {
...
$('#1-out1-button-change').click(function() {
    $.get('include/newhandlers.php?id=1&name=out1&value=change', function(result) {
...
$('#1-out4-button-change').click(function() {
    $.get('include/newhandlers.php?id=1&name=out4&value=change', function(result) {
...
$('#2-out1-button-change').click(function() {
    $.get('include/newhandlers.php?id=2&name=out1&value=change', function(result) {
...
$('#2-out2-button-change').click(function() {
    $.get('include/newhandlers.php?id=2&name=out2&value=change', function(result) {
...
$('#2-out3-button-change').click(function() {
    $.get('include/newhandlers.php?id=2&name=out3&value=change', function(result) {
...
$('#3-out1-button-change').click(function() {
    $.get('include/newhandlers.php?id=3&name=out1&value=change', function(result) {
...
$('#4-out1-button-change').click(function() {
    $.get('include/newhandlers.php?id=4&name=out1&value=change', function(result) {
