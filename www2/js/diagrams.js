...
function loaddata(){
	...
	var charttemp = new google.visualization.LineChart(document.getElementById('chart_div'));
	var charthumi = new google.visualization.LineChart(document.getElementById('chart_div2'));
...
function drawreftemp(datatemp, optionstemp, charttemp){
	$.get('include/diagrams.php?id=7&gettemp=1', function(result) {
		...
		$.get('include/diagrams.php?id=8&gettemp=1', function(result2) {
...
function drawrefhumi(datahumi, optionshumi, charthumi){
	$.get('include/diagrams.php?id=7&gethumi=1', function(result) {
		var nowdate = new Date();
		var hour = nowdate.getHours()
		...
		$.get('include/diagrams.php?id=8&gethumi=1', function(result2) {
			var adata2 = result2.split(",");
			var dlug2 = (adata2.length-1)/3;
...
function drawsensor(datasensor, optionssensor, chartsensor){
	$.get('include/diagrams.php?id=8&getsensordata=1', function(result) {
		var nowdate = new Date();
		var hour = nowdate.getHours()
		...
		$.get('include/diagrams.php?id=7&getsensordata=1', function(result2) {
			var adata2 = result2.split(",");
			var dlug2 = (adata2.length-1)/3;
